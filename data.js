  ...
  education: [
    {
      ...
      endDate: "Jan 2024",
      description:
        "Graduated with honors from the Informatics Engineering program, focusing on software development and engineering principles.",
    },
  ],
  experience: [
    {
    ...
    },
    {
      ...
      endDate: "Aug 2024",
      description:
        "Selected as the Most Progressive Student Graduate from 10 of 180 Participants.",
      responsibilities: [
    ...
    },
    {
      ...
      endDate: "July 2023",
      description:
        "Selected as the Best Mobile Development Graduate from 10% of 5000 participants.",
      responsibilities: [
  ...
  projects: [
    {
      name: "Food App",
      description:
        "Web Service about online food ordering application where users can order food and admin can get reports from user orders.",
      technologies: [
      ...
      year: "2024",
      github: "https://github.com/ridhogaa/food-app-server.git",
      image:
        "https://i.pinimg.com/564x/79/59/ab/7959ab638a6d29a3120cc1508046ed9d.jpg", // Replace with project image
    },
    {
      name: "SimpleBank App",
      description:
        "SimpleBank is a mobile and web-based banking application designed for all users, including users with visual disabilities. SimpleBank is specially designed with blind and low vision friendly features.",
      technologies: [
        "Spring Boot Framework",
        "JPA",
        "PostgreSQL",
      ...
      year: "2024",
      github: "https://github.com/Team-1-RAP/Backend-Java.git",
      image: "https://simplebank-preview.netlify.app/assets/logo-CbWGJAUa.png", // Replace with project image
    },
  ],
  skills: [
